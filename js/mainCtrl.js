...
app.controller('mainCtrl', function ($scope, itunesService) {
    ...
    $scope.getSongData = function() {
        itunesService.getArtist($scope.artist) //since the ng-model creates a $scope variable automatically, and it's already attached to the input, all we have to do is pass that in 
